...
import { SchnorrHardcodedAccountContractArtifact } from '../artifacts/SchnorrHardcodedAccount';
...
export const filteredInterface = SchnorrHardcodedAccountContractArtifact.functions.filter(f => !IGNORE_FUNCTIONS.includes(f.name));
